...
prob.Constraints.const6=xy1(4)<=2;
prob.Constraints.const7=xy2(4)<=2;
prob.Constraints.const8=u0(1)<=1;
prob.Constraints.const9=u1(1)<=1;
prob.Constraints.const10=u0(1)>=-1;
prob.Constraints.const11=u1(1)>=-1;
...
[result,fval,exitflag,output,lambda] = solve(prob,str);
